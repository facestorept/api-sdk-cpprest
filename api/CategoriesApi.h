...
#ifndef IO_SWAGGER_CLIENT_API_CategoriesApi_H_
#define IO_SWAGGER_CLIENT_API_CategoriesApi_H_
...
#include "Inline_response_201_1.h"
...
public:
    ...
    pplx::task<std::shared_ptr<Inline_response_201_1>> addCategories(std::shared_ptr<Category> category);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<void> deleteCategoryById(int64_t id);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<std::shared_ptr<Inline_response_200_1>> getCategories(std::vector<utility::string_t> includes, int32_t limit, std::vector<utility::string_t> orderBy);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="id">ID of category to fetch</param>/// <param name="includes">Include associated objects within response (optional)</param>/// <param name="limit">max records to return (optional)</param>
    pplx::task<std::shared_ptr<Inline_response_201_1>> getCategoryById(int64_t id, std::vector<utility::string_t> includes, int32_t limit);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="id">ID of category to update</param>/// <param name="category">Category to update in store</param>
    pplx::task<void> updateCategoryById(int64_t id, std::shared_ptr<Object> category);
...
#endif /* IO_SWAGGER_CLIENT_API_CategoriesApi_H_ */
