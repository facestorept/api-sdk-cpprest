...
#ifndef IO_SWAGGER_CLIENT_API_CustomersApi_H_
#define IO_SWAGGER_CLIENT_API_CustomersApi_H_
...
{
public:
    CustomersApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~CustomersApi();
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="id">ID of customer</param>/// <param name="includes">Include associated objects within response (optional)</param>
    pplx::task<std::vector<std::shared_ptr<Customer>>> getCustomerById(int64_t id, std::vector<utility::string_t> includes);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<std::vector<std::shared_ptr<Customer>>> getCustomers(std::vector<utility::string_t> includes, int32_t limit, std::vector<utility::string_t> orderBy);
...
#endif /* IO_SWAGGER_CLIENT_API_CustomersApi_H_ */
