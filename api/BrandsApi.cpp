...
BrandsApi::BrandsApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::shared_ptr<Inline_response_201>> BrandsApi::addBrands(std::shared_ptr<Brand> brand)
{

    // verify the required parameter 'brand' is set
    if (brand == nullptr)
    {
        throw ApiException(400, utility::conversions::to_string_t("Missing required parameter 'brand' when calling BrandsApi->addBrands"));
    }


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/brands");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("BrandsApi->addBrands does not produce any supported media type"));
    }
    ...
    else if( consumeHttpContentTypes.find(utility::conversions::to_string_t("multipart/form-data")) != consumeHttpContentTypes.end() )
    {
        ...
        std::shared_ptr<MultipartFormData> multipart(new MultipartFormData);
                if(brand.get())
        {
            brand->toMultipart(multipart, utility::conversions::to_string_t("brand"));
        }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("BrandsApi->addBrands does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling addBrands: ") + response.reason_phrase()
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling addBrands: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling addBrands: unsupported response type"));
        }

        return result;
    });
}
pplx::task<void> BrandsApi::deleteBrandById(int64_t id)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/brands/{id}/");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("BrandsApi->deleteBrandById does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("BrandsApi->deleteBrandById does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling deleteBrandById: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling deleteBrandById: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<std::shared_ptr<Inline_response_201>> BrandsApi::getBrandById(int64_t id, std::vector<utility::string_t> includes, int32_t limit)
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("BrandsApi->getBrandById does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("BrandsApi->getBrandById does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling getBrandById: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling getBrandById: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling getBrandById: unsupported response type"));
        }

        return result;
    });
}
pplx::task<std::shared_ptr<Inline_response_200>> BrandsApi::getBrands(std::vector<utility::string_t> includes, int32_t limit, std::vector<utility::string_t> orderBy)
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("BrandsApi->getBrands does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("BrandsApi->getBrands does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling getBrands: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling getBrands: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling getBrands: unsupported response type"));
        }

        return result;
    });
}
pplx::task<void> BrandsApi::updateCategoryById(int64_t id, std::shared_ptr<Object> brand)
{

    // verify the required parameter 'brand' is set
    if (brand == nullptr)
    {
        throw ApiException(400, utility::conversions::to_string_t("Missing required parameter 'brand' when calling BrandsApi->updateCategoryById"));
    }
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("BrandsApi->updateCategoryById does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("BrandsApi->updateCategoryById does not consume any supported media type"));
    }
...
pplx::task<void> BrandsApi::updateCategoryById_0(int64_t id, std::shared_ptr<Object> brand)
{

    // verify the required parameter 'brand' is set
    if (brand == nullptr)
    {
        throw ApiException(400, utility::conversions::to_string_t("Missing required parameter 'brand' when calling BrandsApi->updateCategoryById_0"));
    }
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("BrandsApi->updateCategoryById_0 does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("BrandsApi->updateCategoryById_0 does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling updateCategoryById_0: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling updateCategoryById_0: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
