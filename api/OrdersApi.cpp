...
OrdersApi::OrdersApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::vector<std::shared_ptr<Order>>> OrdersApi::getOrderById(int64_t id, std::vector<utility::string_t> includes)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/orders/{id}/");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("OrdersApi->getOrderById does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("OrdersApi->getOrderById does not consume any supported media type"));
    }
...
pplx::task<std::vector<std::shared_ptr<Order>>> OrdersApi::getOrders(std::vector<utility::string_t> includes, int32_t limit, std::vector<utility::string_t> orderBy)
{
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling getOrders: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling getOrders: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
