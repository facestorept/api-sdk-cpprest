...
#ifndef IO_SWAGGER_CLIENT_API_TaxesApi_H_
#define IO_SWAGGER_CLIENT_API_TaxesApi_H_


#include "ApiClient.h"

#include "Inline_response_200_2.h"
#include "Inline_response_201_2.h"
#include "Object.h"
#include "Tax.h"
...
public:
    ...
    pplx::task<std::shared_ptr<Inline_response_201_2>> addTaxes(std::shared_ptr<Tax> tax);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<void> deleteTaxById(int64_t id);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="id">ID of tax to fetch</param>/// <param name="limit">max records to return (optional)</param>
    pplx::task<std::shared_ptr<Inline_response_201_2>> getTaxById(int64_t id, int32_t limit);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<std::shared_ptr<Inline_response_200_2>> getTaxes(std::vector<utility::string_t> includes, int32_t limit, std::vector<utility::string_t> orderBy);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="id">ID of tax to update</param>/// <param name="tax">Tax to add to the store</param>
    pplx::task<std::shared_ptr<Inline_response_201_2>> updateTaxById(int64_t id, std::shared_ptr<Tax> tax);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="id">ID of tax to update</param>/// <param name="tax">Tax to add to the store</param>
    pplx::task<std::shared_ptr<Inline_response_201_2>> updateTaxById_0(int64_t id, std::shared_ptr<Tax> tax);
...
#endif /* IO_SWAGGER_CLIENT_API_TaxesApi_H_ */
