...
#include "ProductsAttributesApi.h"
#include "IHttpBody.h"
#include "JsonBody.h"
...
ProductsAttributesApi::ProductsAttributesApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::vector<std::shared_ptr<Attribute>>> ProductsAttributesApi::addProductsAttributes(std::shared_ptr<Attribute> attribute)
{

    // verify the required parameter 'attribute' is set
    if (attribute == nullptr)
    {
        throw ApiException(400, utility::conversions::to_string_t("Missing required parameter 'attribute' when calling ProductsAttributesApi->addProductsAttributes"));
    }


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/attributes");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ProductsAttributesApi->addProductsAttributes does not produce any supported media type"));
    }
    ...
    if ( consumeHttpContentTypes.size() == 0 || consumeHttpContentTypes.find(utility::conversions::to_string_t("application/json")) != consumeHttpContentTypes.end() )
    {
        ...
        json = ModelBase::toJson(attribute);
    ...
    else if( consumeHttpContentTypes.find(utility::conversions::to_string_t("multipart/form-data")) != consumeHttpContentTypes.end() )
    {
        ...
        std::shared_ptr<MultipartFormData> multipart(new MultipartFormData);
                if(attribute.get())
        {
            attribute->toMultipart(multipart, utility::conversions::to_string_t("attribute"));
        }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("ProductsAttributesApi->addProductsAttributes does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling addProductsAttributes: ") + response.reason_phrase()
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling addProductsAttributes: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        if(responseHttpContentType == utility::conversions::to_string_t("application/json"))
        {
            ...
            {
                std::shared_ptr<Attribute> itemObj(new Attribute());
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling addProductsAttributes: unsupported response type"));
        }

        return result;
    });
}
pplx::task<void> ProductsAttributesApi::deleteProductAttributeById(int64_t id)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/attributes/{id}/");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ProductsAttributesApi->deleteProductAttributeById does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("ProductsAttributesApi->deleteProductAttributeById does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling deleteProductAttributeById: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling deleteProductAttributeById: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<std::shared_ptr<Attribute>> ProductsAttributesApi::getProductAttributeById(int64_t id, std::vector<utility::string_t> includes)
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ProductsAttributesApi->getProductAttributeById does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("ProductsAttributesApi->getProductAttributeById does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling getProductAttributeById: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling getProductAttributeById: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        std::shared_ptr<Attribute> result(new Attribute());
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling getProductAttributeById: unsupported response type"));
        }

        return result;
    });
}
pplx::task<std::vector<std::shared_ptr<Attribute>>> ProductsAttributesApi::getProductsAttributes(std::vector<utility::string_t> includes, int32_t limit, std::vector<utility::string_t> orderBy)
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ProductsAttributesApi->getProductsAttributes does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("ProductsAttributesApi->getProductsAttributes does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling getProductsAttributes: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling getProductsAttributes: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling getProductsAttributes: unsupported response type"));
        }

        return result;
    });
}
pplx::task<std::shared_ptr<Attribute>> ProductsAttributesApi::updateProductAttributeById(int64_t id, std::shared_ptr<Attribute> product_attribute)
{

    // verify the required parameter 'product_attribute' is set
    if (product_attribute == nullptr)
    {
        throw ApiException(400, utility::conversions::to_string_t("Missing required parameter 'product_attribute' when calling ProductsAttributesApi->updateProductAttributeById"));
    }
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ProductsAttributesApi->updateProductAttributeById does not produce any supported media type"));
    }
    ...
    if ( consumeHttpContentTypes.size() == 0 || consumeHttpContentTypes.find(utility::conversions::to_string_t("application/json")) != consumeHttpContentTypes.end() )
    {
        ...
        json = ModelBase::toJson(product_attribute);
    ...
    else if( consumeHttpContentTypes.find(utility::conversions::to_string_t("multipart/form-data")) != consumeHttpContentTypes.end() )
    {
        ...
        {
            product_attribute->toMultipart(multipart, utility::conversions::to_string_t("product_attribute"));
        }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("ProductsAttributesApi->updateProductAttributeById does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling updateProductAttributeById: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling updateProductAttributeById: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling updateProductAttributeById: unsupported response type"));
        }
