...
ShippingsApi::ShippingsApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::shared_ptr<Inline_response_201_3>> ShippingsApi::addShipping(std::shared_ptr<Shipping> shipping)
{

    // verify the required parameter 'shipping' is set
    if (shipping == nullptr)
    {
        throw ApiException(400, utility::conversions::to_string_t("Missing required parameter 'shipping' when calling ShippingsApi->addShipping"));
    }


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/shippings");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ShippingsApi->addShipping does not produce any supported media type"));
    }
    ...
    if ( consumeHttpContentTypes.size() == 0 || consumeHttpContentTypes.find(utility::conversions::to_string_t("application/json")) != consumeHttpContentTypes.end() )
    {
        ...
        json = ModelBase::toJson(shipping);
    ...
    else if( consumeHttpContentTypes.find(utility::conversions::to_string_t("multipart/form-data")) != consumeHttpContentTypes.end() )
    {
        ...
        std::shared_ptr<MultipartFormData> multipart(new MultipartFormData);
                if(shipping.get())
        {
            shipping->toMultipart(multipart, utility::conversions::to_string_t("shipping"));
        }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("ShippingsApi->addShipping does not consume any supported media type"));
    }

    // authentication (APIKeyHeader) required
    {
        utility::string_t apiKey = apiConfiguration->getApiKey(utility::conversions::to_string_t("APIToken"));
        if ( apiKey.size() > 0 )
        {
            headerParams[utility::conversions::to_string_t("APIToken")] = apiKey;
        }
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling addShipping: ") + response.reason_phrase()
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling addShipping: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    {
        std::shared_ptr<Inline_response_201_3> result(new Inline_response_201_3());
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling addShipping: unsupported response type"));
        }

        return result;
    });
}
pplx::task<void> ShippingsApi::deleteShippingById(int64_t id)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/shippings/{id}/");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ShippingsApi->deleteShippingById does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("ShippingsApi->deleteShippingById does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling deleteShippingById: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling deleteShippingById: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<std::shared_ptr<Inline_response_201_3>> ShippingsApi::getShippingById(int64_t id, int32_t limit)
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ShippingsApi->getShippingById does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("ShippingsApi->getShippingById does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling getShippingById: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling getShippingById: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling getShippingById: unsupported response type"));
        }

        return result;
    });
}
pplx::task<std::shared_ptr<Inline_response_200_3>> ShippingsApi::getShippings(std::vector<utility::string_t> includes, int32_t limit, std::vector<utility::string_t> orderBy)
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ShippingsApi->getShippings does not produce any supported media type"));
    }
    ...
    {
        queryParams[utility::conversions::to_string_t("includes")] = ApiClient::parameterToArrayString<utility::string_t>(includes);
    }
    ...
    {
        queryParams[utility::conversions::to_string_t("order_by")] = ApiClient::parameterToArrayString<utility::string_t>(orderBy);
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("ShippingsApi->getShippings does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling getShippings: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling getShippings: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling getShippings: unsupported response type"));
        }

        return result;
    });
}
pplx::task<std::shared_ptr<Inline_response_201_3>> ShippingsApi::updateShippingById(int64_t id, std::shared_ptr<Shipping> tax)
{

    // verify the required parameter 'tax' is set
    if (tax == nullptr)
    {
        throw ApiException(400, utility::conversions::to_string_t("Missing required parameter 'tax' when calling ShippingsApi->updateShippingById"));
    }
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ShippingsApi->updateShippingById does not produce any supported media type"));
    }
    ...
    else if( consumeHttpContentTypes.find(utility::conversions::to_string_t("multipart/form-data")) != consumeHttpContentTypes.end() )
    {
        ...
        std::shared_ptr<MultipartFormData> multipart(new MultipartFormData);
                if(tax.get())
        {
            tax->toMultipart(multipart, utility::conversions::to_string_t("tax"));
        }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("ShippingsApi->updateShippingById does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling updateShippingById: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling updateShippingById: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling updateShippingById: unsupported response type"));
        }

        return result;
    });
}
pplx::task<std::shared_ptr<Inline_response_201_3>> ShippingsApi::updateShippingById_0(int64_t id, std::shared_ptr<Shipping> tax)
{

    // verify the required parameter 'tax' is set
    if (tax == nullptr)
    {
        throw ApiException(400, utility::conversions::to_string_t("Missing required parameter 'tax' when calling ShippingsApi->updateShippingById_0"));
    }
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ShippingsApi->updateShippingById_0 does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("ShippingsApi->updateShippingById_0 does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling updateShippingById_0: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling updateShippingById_0: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling updateShippingById_0: unsupported response type"));
        }
