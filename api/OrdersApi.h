...
#ifndef IO_SWAGGER_CLIENT_API_OrdersApi_H_
#define IO_SWAGGER_CLIENT_API_OrdersApi_H_
...
{
public:
    OrdersApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~OrdersApi();
    /// <summary>
    /// 
    /// </summary>
    ...
    pplx::task<std::vector<std::shared_ptr<Order>>> getOrderById(int64_t id, std::vector<utility::string_t> includes);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<std::vector<std::shared_ptr<Order>>> getOrders(std::vector<utility::string_t> includes, int32_t limit, std::vector<utility::string_t> orderBy);
...
#endif /* IO_SWAGGER_CLIENT_API_OrdersApi_H_ */
