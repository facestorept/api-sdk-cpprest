...
/*
 * ProductsAttributesApi.h
 *
 * 
 */

#ifndef IO_SWAGGER_CLIENT_API_ProductsAttributesApi_H_
#define IO_SWAGGER_CLIENT_API_ProductsAttributesApi_H_
...
{
public:
    ProductsAttributesApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~ProductsAttributesApi();
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<std::vector<std::shared_ptr<Attribute>>> addProductsAttributes(std::shared_ptr<Attribute> attribute);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<void> deleteProductAttributeById(int64_t id);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="id">ID of attribute to fetch</param>/// <param name="includes">Include associated objects within response (optional)</param>
    pplx::task<std::shared_ptr<Attribute>> getProductAttributeById(int64_t id, std::vector<utility::string_t> includes);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<std::vector<std::shared_ptr<Attribute>>> getProductsAttributes(std::vector<utility::string_t> includes, int32_t limit, std::vector<utility::string_t> orderBy);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="id">ID of attribute to update</param>/// <param name="product_attribute">Attribute to add to the store</param>
    pplx::task<std::shared_ptr<Attribute>> updateProductAttributeById(int64_t id, std::shared_ptr<Attribute> product_attribute);
...
#endif /* IO_SWAGGER_CLIENT_API_ProductsAttributesApi_H_ */
