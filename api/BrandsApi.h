...
#ifndef IO_SWAGGER_CLIENT_API_BrandsApi_H_
#define IO_SWAGGER_CLIENT_API_BrandsApi_H_
...
public:
    ...
    pplx::task<std::shared_ptr<Inline_response_201>> addBrands(std::shared_ptr<Brand> brand);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<void> deleteBrandById(int64_t id);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="id">ID of brand to fetch</param>/// <param name="includes">Include associated objects within response (optional)</param>/// <param name="limit">max records to return (optional)</param>
    pplx::task<std::shared_ptr<Inline_response_201>> getBrandById(int64_t id, std::vector<utility::string_t> includes, int32_t limit);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<std::shared_ptr<Inline_response_200>> getBrands(std::vector<utility::string_t> includes, int32_t limit, std::vector<utility::string_t> orderBy);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="id">ID of brand to update</param>/// <param name="brand">Brand to update in store</param>
    pplx::task<void> updateCategoryById(int64_t id, std::shared_ptr<Object> brand);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="id">ID of brand to update</param>/// <param name="brand">Brand to update in store</param>
    pplx::task<void> updateCategoryById_0(int64_t id, std::shared_ptr<Object> brand);
...
#endif /* IO_SWAGGER_CLIENT_API_BrandsApi_H_ */
