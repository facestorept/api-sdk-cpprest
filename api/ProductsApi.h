...
#ifndef IO_SWAGGER_CLIENT_API_ProductsApi_H_
#define IO_SWAGGER_CLIENT_API_ProductsApi_H_


#include "ApiClient.h"

#include "Inline_response_200_6.h"
#include "Inline_response_201_4.h"
...
public:
    ...
    pplx::task<std::shared_ptr<Inline_response_201_4>> addProduct(std::shared_ptr<Product> product);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<void> deleteProductById(int64_t id);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="id">ID of product to fetch</param>/// <param name="includes">Include associated objects within response (optional)</param>/// <param name="limit">max records to return (optional)</param>
    pplx::task<std::shared_ptr<Inline_response_201_4>> getProductById(int64_t id, std::vector<utility::string_t> includes, int32_t limit);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<std::shared_ptr<Inline_response_200_6>> getProducts(std::vector<utility::string_t> includes, int32_t limit, std::vector<utility::string_t> orderBy);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="id">ID of product to update</param>/// <param name="tax">Product to add to the store</param>
    pplx::task<void> updateProductById(int64_t id, std::shared_ptr<Product> tax);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="id">ID of product to update</param>/// <param name="tax">Product to add to the store</param>
    pplx::task<void> updateProductById_0(int64_t id, std::shared_ptr<Product> tax);
...
#endif /* IO_SWAGGER_CLIENT_API_ProductsApi_H_ */
