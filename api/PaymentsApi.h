...
#ifndef IO_SWAGGER_CLIENT_API_PaymentsApi_H_
#define IO_SWAGGER_CLIENT_API_PaymentsApi_H_
...
public:
    ...
    pplx::task<std::shared_ptr<Inline_response_200_5>> getPaymentById(int64_t id);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<std::shared_ptr<Inline_response_200_4>> getPayments(std::vector<utility::string_t> includes, int32_t limit, std::vector<utility::string_t> orderBy);
...
#endif /* IO_SWAGGER_CLIENT_API_PaymentsApi_H_ */
