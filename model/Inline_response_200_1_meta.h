...
#ifndef IO_SWAGGER_CLIENT_MODEL_Inline_response_200_1_meta_H_
#define IO_SWAGGER_CLIENT_MODEL_Inline_response_200_1_meta_H_
...
public:
    ...
    /// 
    /// </summary>
    utility::string_t getTotal() const;
    bool totalIsSet() const;
    void unsetTotal();
    void setTotal(utility::string_t value);

protected:
    utility::string_t m_Total;
    bool m_TotalIsSet;
};
...
#endif /* IO_SWAGGER_CLIENT_MODEL_Inline_response_200_1_meta_H_ */
