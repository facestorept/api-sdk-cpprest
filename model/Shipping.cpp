...
void Shipping::validate()
{
    // TODO: implement validation
}

web::json::value Shipping::toJson() const
{
...
void Shipping::fromJson(web::json::value& val)
{
...
void Shipping::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Shipping::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t Shipping::getId() const
{
    return m_Id;
}


void Shipping::setId(int64_t value)
{
    m_Id = value;
    
}
utility::string_t Shipping::getName() const
{
    return m_Name;
}


void Shipping::setName(utility::string_t value)
{
    m_Name = value;
    m_NameIsSet = true;
}
bool Shipping::nameIsSet() const
{
    return m_NameIsSet;
}

void Shipping::unsetName()
{
    m_NameIsSet = false;
}

utility::string_t Shipping::getImage() const
{
    return m_Image;
}


void Shipping::setImage(utility::string_t value)
{
    m_Image = value;
    m_ImageIsSet = true;
}
bool Shipping::imageIsSet() const
{
    return m_ImageIsSet;
}

void Shipping::unsetImage()
{
    m_ImageIsSet = false;
}

bool Shipping::isActive() const
{
    return m_Active;
}


void Shipping::setActive(bool value)
{
    m_Active = value;
    m_ActiveIsSet = true;
}
bool Shipping::activeIsSet() const
{
    return m_ActiveIsSet;
}

void Shipping::unsetActive()
{
    m_ActiveIsSet = false;
}

utility::datetime Shipping::getCreatedAt() const
{
    return m_Created_at;
}


void Shipping::setCreatedAt(utility::datetime value)
{
    m_Created_at = value;
    m_Created_atIsSet = true;
}
bool Shipping::createdAtIsSet() const
{
    return m_Created_atIsSet;
}

void Shipping::unsetCreated_at()
{
    m_Created_atIsSet = false;
}

utility::datetime Shipping::getUpdatedAt() const
{
    return m_Updated_at;
}


void Shipping::setUpdatedAt(utility::datetime value)
{
    m_Updated_at = value;
    m_Updated_atIsSet = true;
}
bool Shipping::updatedAtIsSet() const
{
    return m_Updated_atIsSet;
}

void Shipping::unsetUpdated_at()
{
    m_Updated_atIsSet = false;
}
