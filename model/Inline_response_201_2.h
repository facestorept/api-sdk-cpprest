...
#ifndef IO_SWAGGER_CLIENT_MODEL_Inline_response_201_2_H_
#define IO_SWAGGER_CLIENT_MODEL_Inline_response_201_2_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<Tax>>& getData();
    bool dataIsSet() const;
    void unsetData();
    void setData(std::vector<std::shared_ptr<Tax>> value);

protected:
    std::vector<std::shared_ptr<Tax>> m_Data;
    bool m_DataIsSet;
};
...
#endif /* IO_SWAGGER_CLIENT_MODEL_Inline_response_201_2_H_ */
