...
#ifndef IO_SWAGGER_CLIENT_MODEL_Inline_response_201_3_H_
#define IO_SWAGGER_CLIENT_MODEL_Inline_response_201_3_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<Shipping>>& getData();
    bool dataIsSet() const;
    void unsetData();
    void setData(std::vector<std::shared_ptr<Shipping>> value);

protected:
    std::vector<std::shared_ptr<Shipping>> m_Data;
    bool m_DataIsSet;
};
...
#endif /* IO_SWAGGER_CLIENT_MODEL_Inline_response_201_3_H_ */
