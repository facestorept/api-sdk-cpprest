...
#ifndef IO_SWAGGER_CLIENT_MODEL_Options_H_
#define IO_SWAGGER_CLIENT_MODEL_Options_H_
...
public:
    ...
    /// 
    /// </summary>
    utility::string_t getAuxCode() const;
    bool auxCodeIsSet() const;
    void unsetAux_code();
    void setAuxCode(utility::string_t value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    utility::string_t m_Aux_code;
    bool m_Aux_codeIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_Options_H_ */
