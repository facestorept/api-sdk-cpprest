...
#ifndef IO_SWAGGER_CLIENT_MODEL_Attribute_options_H_
#define IO_SWAGGER_CLIENT_MODEL_Attribute_options_H_
...
public:
    ...
    /////////////////////////////////////////////
    /// Attribute_options members

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<Options> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(std::shared_ptr<Options> value);

protected:
    std::shared_ptr<Options> m_Data;
    bool m_DataIsSet;
};
...
#endif /* IO_SWAGGER_CLIENT_MODEL_Attribute_options_H_ */
