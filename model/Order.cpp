...
utility::string_t Order::getName() const
{
    return m_Name;
}


void Order::setName(utility::string_t value)
{
    m_Name = value;
    m_NameIsSet = true;
}
bool Order::nameIsSet() const
{
    return m_NameIsSet;
}

void Order::unsetName()
{
    m_NameIsSet = false;
}

utility::datetime Order::getCreatedAt() const
{
    return m_Created_at;
}


void Order::setCreatedAt(utility::datetime value)
{
    m_Created_at = value;
...
utility::datetime Order::getUpdatedAt() const
{
    return m_Updated_at;
}


void Order::setUpdatedAt(utility::datetime value)
{
    m_Updated_at = value;
    m_Updated_atIsSet = true;
}
bool Order::updatedAtIsSet() const
{
    return m_Updated_atIsSet;
}

void Order::unsetUpdated_at()
{
    m_Updated_atIsSet = false;
}
