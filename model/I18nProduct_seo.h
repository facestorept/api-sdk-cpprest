...
#ifndef IO_SWAGGER_CLIENT_MODEL_I18nProduct_seo_H_
#define IO_SWAGGER_CLIENT_MODEL_I18nProduct_seo_H_
...
/// 
/// </summary>
class  I18nProduct_seo
    : public ModelBase
{
public:
    I18nProduct_seo();
    virtual ~I18nProduct_seo();
    ...
    void unsetKeywords();
    void setKeywords(utility::string_t value);
    /// <summary>
    /// 
    /// </summary>
...
#endif /* IO_SWAGGER_CLIENT_MODEL_I18nProduct_seo_H_ */
