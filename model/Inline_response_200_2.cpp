...
std::vector<std::shared_ptr<Tax>>& Inline_response_200_2::getData()
{
    return m_Data;
}

void Inline_response_200_2::setData(std::vector<std::shared_ptr<Tax>> value)
{
    m_Data = value;
    m_DataIsSet = true;
}
bool Inline_response_200_2::dataIsSet() const
{
    return m_DataIsSet;
}

void Inline_response_200_2::unsetData()
{
    m_DataIsSet = false;
}

std::shared_ptr<Inline_response_200_1_meta> Inline_response_200_2::getMeta() const
{
    return m_Meta;
}


void Inline_response_200_2::setMeta(std::shared_ptr<Inline_response_200_1_meta> value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}
