...
int64_t Brand::getId() const
{
    return m_Id;
}


void Brand::setId(int64_t value)
{
    m_Id = value;
    
}
int64_t Brand::getPosition() const
{
    return m_Position;
}


void Brand::setPosition(int64_t value)
{
    m_Position = value;
    m_PositionIsSet = true;
}
bool Brand::positionIsSet() const
{
    return m_PositionIsSet;
}

void Brand::unsetPosition()
{
    m_PositionIsSet = false;
}

utility::string_t Brand::getImageSmall() const
{
    return m_Image_small;
}


void Brand::setImageSmall(utility::string_t value)
{
    m_Image_small = value;
    m_Image_smallIsSet = true;
}
bool Brand::imageSmallIsSet() const
{
    return m_Image_smallIsSet;
}

void Brand::unsetImage_small()
{
    m_Image_smallIsSet = false;
}

utility::string_t Brand::getImageLarger() const
{
    return m_Image_larger;
}


void Brand::setImageLarger(utility::string_t value)
{
    m_Image_larger = value;
    m_Image_largerIsSet = true;
}
bool Brand::imageLargerIsSet() const
{
    return m_Image_largerIsSet;
}

void Brand::unsetImage_larger()
{
    m_Image_largerIsSet = false;
}

bool Brand::isActive() const
{
    return m_Active;
}


void Brand::setActive(bool value)
{
    m_Active = value;
    m_ActiveIsSet = true;
}
bool Brand::activeIsSet() const
{
    return m_ActiveIsSet;
}

void Brand::unsetActive()
{
    m_ActiveIsSet = false;
}
...
void Brand::unsetUpdated_at()
{
    m_Updated_atIsSet = false;
}

std::vector<utility::string_t>& Brand::getVisibility()
{
    return m_Visibility;
}

void Brand::setVisibility(std::vector<utility::string_t> value)
{
    m_Visibility = value;
    m_VisibilityIsSet = true;
}
bool Brand::visibilityIsSet() const
{
    return m_VisibilityIsSet;
}

void Brand::unsetVisibility()
{
    m_VisibilityIsSet = false;
}

std::vector<std::shared_ptr<I18n>>& Brand::getI18n()
{
    return m_I18n;
}

void Brand::setI18n(std::vector<std::shared_ptr<I18n>> value)
{
    m_I18n = value;
    m_I18nIsSet = true;
}
bool Brand::i18nIsSet() const
{
    return m_I18nIsSet;
}

void Brand::unsetI18n()
{
    m_I18nIsSet = false;
}
