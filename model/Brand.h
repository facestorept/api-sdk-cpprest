...
#ifndef IO_SWAGGER_CLIENT_MODEL_Brand_H_
#define IO_SWAGGER_CLIENT_MODEL_Brand_H_
...
public:
    ...
    /// 
    /// </summary>
    utility::string_t getImageSmall() const;
    bool imageSmallIsSet() const;
    void unsetImage_small();
    void setImageSmall(utility::string_t value);
    /// <summary>
    /// 
    /// </summary>
    utility::string_t getImageLarger() const;
    bool imageLargerIsSet() const;
    void unsetImage_larger();
    void setImageLarger(utility::string_t value);
    /// <summary>
    /// 
    /// </summary>
    bool isActive() const;
    ...
    /// </summary>
    std::vector<std::shared_ptr<I18n>>& getI18n();
    bool i18nIsSet() const;
    void unsetI18n();
    void setI18n(std::vector<std::shared_ptr<I18n>> value);

protected:
    int64_t m_Id;
        int64_t m_Position;
    bool m_PositionIsSet;
    utility::string_t m_Image_small;
    bool m_Image_smallIsSet;
    utility::string_t m_Image_larger;
    bool m_Image_largerIsSet;
    bool m_Active;
    bool m_ActiveIsSet;
    ...
    std::vector<std::shared_ptr<I18n>> m_I18n;
    bool m_I18nIsSet;
};
...
#endif /* IO_SWAGGER_CLIENT_MODEL_Brand_H_ */
