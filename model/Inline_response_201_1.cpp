...
web::json::value Inline_response_201_1::toJson() const
{
...
void Inline_response_201_1::fromJson(web::json::value& val)
{
    {
        m_Data.clear();
        std::vector<web::json::value> jsonArray;
...
void Inline_response_201_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Inline_response_201_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::vector<std::shared_ptr<Category>>& Inline_response_201_1::getData()
{
    return m_Data;
}

void Inline_response_201_1::setData(std::vector<std::shared_ptr<Category>> value)
{
    m_Data = value;
    m_DataIsSet = true;
}
bool Inline_response_201_1::dataIsSet() const
{
    return m_DataIsSet;
}

void Inline_response_201_1::unsetData()
{
    m_DataIsSet = false;
}
