...
{
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("data")].as_array() )
        {
            if(item.is_null())
            {
                m_Data.push_back( std::shared_ptr<Payment>(nullptr) );
            }
            else
            {
...
std::vector<std::shared_ptr<Payment>>& Inline_response_200_4::getData()
{
    return m_Data;
}

void Inline_response_200_4::setData(std::vector<std::shared_ptr<Payment>> value)
{
    m_Data = value;
    m_DataIsSet = true;
}
bool Inline_response_200_4::dataIsSet() const
{
    return m_DataIsSet;
}

void Inline_response_200_4::unsetData()
{
    m_DataIsSet = false;
}

std::shared_ptr<Inline_response_200_1_meta> Inline_response_200_4::getMeta() const
{
    return m_Meta;
}


void Inline_response_200_4::setMeta(std::shared_ptr<Inline_response_200_1_meta> value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}
bool Inline_response_200_4::metaIsSet() const
{
    return m_MetaIsSet;
}

void Inline_response_200_4::unsetMeta()
{
    m_MetaIsSet = false;
}
