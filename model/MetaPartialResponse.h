...
/*
 * MetaPartialResponse.h
 *
 * 
 */

#ifndef IO_SWAGGER_CLIENT_MODEL_MetaPartialResponse_H_
#define IO_SWAGGER_CLIENT_MODEL_MetaPartialResponse_H_
...
/// 
/// </summary>
class  MetaPartialResponse
    : public ModelBase
{
public:
    MetaPartialResponse();
    virtual ~MetaPartialResponse();
    ...
    /////////////////////////////////////////////
    /// MetaPartialResponse members

    /// <summary>
    /// 
    /// </summary>
    utility::string_t getFirstPageUrl() const;
    bool firstPageUrlIsSet() const;
    void unsetFirst_page_url();
    void setFirstPageUrl(utility::string_t value);
    /// <summary>
    /// 
    /// </summary>
    utility::string_t getLastPageUrl() const;
    bool lastPageUrlIsSet() const;
    void unsetLast_page_url();
    void setLastPageUrl(utility::string_t value);
    /// <summary>
    /// 
    /// </summary>
    utility::string_t getNextPageUrl() const;
    bool nextPageUrlIsSet() const;
    void unsetNext_page_url();
    void setNextPageUrl(utility::string_t value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    utility::string_t getPrevPageUrl() const;
    bool prevPageUrlIsSet() const;
    void unsetPrev_page_url();
    void setPrevPageUrl(utility::string_t value);

protected:
    utility::string_t m_First_page_url;
    bool m_First_page_urlIsSet;
    utility::string_t m_Last_page_url;
    bool m_Last_page_urlIsSet;
    utility::string_t m_Next_page_url;
    bool m_Next_page_urlIsSet;
    utility::string_t m_Path;
    bool m_PathIsSet;
    utility::string_t m_Prev_page_url;
    bool m_Prev_page_urlIsSet;
};
...
#endif /* IO_SWAGGER_CLIENT_MODEL_MetaPartialResponse_H_ */
