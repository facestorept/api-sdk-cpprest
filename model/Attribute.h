...
#ifndef IO_SWAGGER_CLIENT_MODEL_Attribute_H_
#define IO_SWAGGER_CLIENT_MODEL_Attribute_H_
...
public:
    ...
    bool isSearchableIsSet() const;
    void unsetIs_searchable();
    void setIsSearchable(bool value);
    /// <summary>
    /// 
    /// </summary>
    bool isActive() const;
    ...
    /// 
    /// </summary>
    std::shared_ptr<Attribute_options> getOptions() const;
    bool optionsIsSet() const;
    void unsetOptions();
    void setOptions(std::shared_ptr<Attribute_options> value);
    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<I18n> getI18n() const;
    bool i18nIsSet() const;
    void unsetI18n();
    void setI18n(std::shared_ptr<I18n> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    bool m_Is_searchableIsSet;
    bool m_Active;
    bool m_ActiveIsSet;
    std::shared_ptr<Attribute_options> m_Options;
    bool m_OptionsIsSet;
    std::shared_ptr<I18n> m_I18n;
    bool m_I18nIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_Attribute_H_ */
