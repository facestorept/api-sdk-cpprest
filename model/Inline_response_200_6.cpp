...
{
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("data")].as_array() )
        {
            if(item.is_null())
            {
                m_Data.push_back( std::shared_ptr<Product>(nullptr) );
            }
            else
            {
                std::shared_ptr<Product> newItem(new Product());
    ...
    {
        if(!val[utility::conversions::to_string_t("meta")].is_null())
        {
            std::shared_ptr<Inline_response_200_1_meta> newItem(new Inline_response_200_1_meta());
            newItem->fromJson(val[utility::conversions::to_string_t("meta")]);
            setMeta( newItem );
        }
    }
}
...
std::vector<std::shared_ptr<Product>>& Inline_response_200_6::getData()
{
    return m_Data;
}

void Inline_response_200_6::setData(std::vector<std::shared_ptr<Product>> value)
{
    m_Data = value;
    m_DataIsSet = true;
}
bool Inline_response_200_6::dataIsSet() const
{
    return m_DataIsSet;
}

void Inline_response_200_6::unsetData()
{
    m_DataIsSet = false;
}

std::shared_ptr<Inline_response_200_1_meta> Inline_response_200_6::getMeta() const
{
    return m_Meta;
}


void Inline_response_200_6::setMeta(std::shared_ptr<Inline_response_200_1_meta> value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}
bool Inline_response_200_6::metaIsSet() const
{
    return m_MetaIsSet;
}

void Inline_response_200_6::unsetMeta()
{
    m_MetaIsSet = false;
}
