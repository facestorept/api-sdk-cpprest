...
web::json::value Tax::toJson() const
{
    ...
    {
        val[utility::conversions::to_string_t("is_default")] = ModelBase::toJson(m_Is_default);
    }
    if(m_ActiveIsSet)
    {
...
void Tax::fromJson(web::json::value& val)
{
    ...
    {
        setIsDefault(ModelBase::boolFromJson(val[utility::conversions::to_string_t("is_default")]));
    }
...
void Tax::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Is_defaultIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("is_default"), m_Is_default));
    }
    if(m_ActiveIsSet)
    {
...
void Tax::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("is_default")))
    {
        setIsDefault(ModelBase::boolFromHttpContent(multipart->getContent(utility::conversions::to_string_t("is_default"))));
    }
...
int64_t Tax::getId() const
{
    return m_Id;
}


void Tax::setId(int64_t value)
{
    m_Id = value;
    
}
utility::string_t Tax::getName() const
{
    return m_Name;
}


void Tax::setName(utility::string_t value)
{
    m_Name = value;
    m_NameIsSet = true;
}
bool Tax::nameIsSet() const
{
    return m_NameIsSet;
}
...
bool Tax::isIsDefault() const
{
    return m_Is_default;
}


void Tax::setIsDefault(bool value)
{
    m_Is_default = value;
    m_Is_defaultIsSet = true;
}
bool Tax::isDefaultIsSet() const
{
    return m_Is_defaultIsSet;
}

void Tax::unsetIs_default()
{
    m_Is_defaultIsSet = false;
}

bool Tax::isActive() const
{
    return m_Active;
}


void Tax::setActive(bool value)
{
    m_Active = value;
    m_ActiveIsSet = true;
}
bool Tax::activeIsSet() const
{
    return m_ActiveIsSet;
}

void Tax::unsetActive()
{
    m_ActiveIsSet = false;
}

utility::datetime Tax::getCreatedAt() const
{
    return m_Created_at;
}


void Tax::setCreatedAt(utility::datetime value)
{
    m_Created_at = value;
    m_Created_atIsSet = true;
}
bool Tax::createdAtIsSet() const
{
    return m_Created_atIsSet;
}

void Tax::unsetCreated_at()
{
    m_Created_atIsSet = false;
}

utility::datetime Tax::getUpdatedAt() const
{
    return m_Updated_at;
}


void Tax::setUpdatedAt(utility::datetime value)
{
    m_Updated_at = value;
    m_Updated_atIsSet = true;
}
bool Tax::updatedAtIsSet() const
{
    return m_Updated_atIsSet;
}

void Tax::unsetUpdated_at()
{
    m_Updated_atIsSet = false;
}
