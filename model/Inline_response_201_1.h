...
#ifndef IO_SWAGGER_CLIENT_MODEL_Inline_response_201_1_H_
#define IO_SWAGGER_CLIENT_MODEL_Inline_response_201_1_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<Category>>& getData();
    bool dataIsSet() const;
    void unsetData();
    void setData(std::vector<std::shared_ptr<Category>> value);

protected:
    std::vector<std::shared_ptr<Category>> m_Data;
    bool m_DataIsSet;
};
...
#endif /* IO_SWAGGER_CLIENT_MODEL_Inline_response_201_1_H_ */
