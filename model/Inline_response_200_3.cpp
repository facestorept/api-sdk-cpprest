...
{
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("data")].as_array() )
        {
            if(item.is_null())
            {
                m_Data.push_back( std::shared_ptr<Shipping>(nullptr) );
            }
            else
            {
                std::shared_ptr<Shipping> newItem(new Shipping());
...
std::vector<std::shared_ptr<Shipping>>& Inline_response_200_3::getData()
{
    return m_Data;
}

void Inline_response_200_3::setData(std::vector<std::shared_ptr<Shipping>> value)
{
    m_Data = value;
    m_DataIsSet = true;
}
bool Inline_response_200_3::dataIsSet() const
{
    return m_DataIsSet;
}

void Inline_response_200_3::unsetData()
{
    m_DataIsSet = false;
}

std::shared_ptr<Inline_response_200_1_meta> Inline_response_200_3::getMeta() const
{
    return m_Meta;
}


void Inline_response_200_3::setMeta(std::shared_ptr<Inline_response_200_1_meta> value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}
