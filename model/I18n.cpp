...
web::json::value I18n::toJson() const
{
...
void I18n::fromJson(web::json::value& val)
{
...
void I18n::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void I18n::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t I18n::getLocale() const
{
    return m_Locale;
}


void I18n::setLocale(utility::string_t value)
{
    m_Locale = value;
    
}
utility::string_t I18n::getName() const
{
    return m_Name;
}


void I18n::setName(utility::string_t value)
{
    m_Name = value;
    
}
utility::string_t I18n::getDescription() const
{
    return m_Description;
}


void I18n::setDescription(utility::string_t value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}
bool I18n::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void I18n::unsetDescription()
{
    m_DescriptionIsSet = false;
}
