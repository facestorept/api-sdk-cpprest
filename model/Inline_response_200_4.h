...
#ifndef IO_SWAGGER_CLIENT_MODEL_Inline_response_200_4_H_
#define IO_SWAGGER_CLIENT_MODEL_Inline_response_200_4_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<Payment>>& getData();
    bool dataIsSet() const;
    void unsetData();
    void setData(std::vector<std::shared_ptr<Payment>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    std::vector<std::shared_ptr<Payment>> m_Data;
    bool m_DataIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_Inline_response_200_4_H_ */
