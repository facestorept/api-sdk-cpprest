...
I18nProduct_seo::I18nProduct_seo()
{
...
void I18nProduct_seo::validate()
{
    // TODO: implement validation
}

web::json::value I18nProduct_seo::toJson() const
{
    ...
    if(m_KeywordsIsSet)
    {
        val[utility::conversions::to_string_t("keywords")] = ModelBase::toJson(m_Keywords);
    }
...
void I18nProduct_seo::fromJson(web::json::value& val)
{
    ...
    {
        setKeywords(ModelBase::stringFromJson(val[utility::conversions::to_string_t("keywords")]));
    }
...
void I18nProduct_seo::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_KeywordsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("keywords"), m_Keywords));
...
void I18nProduct_seo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("keywords")))
    {
        setKeywords(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("keywords"))));
    }
...
utility::string_t I18nProduct_seo::getTitle() const
{
    return m_Title;
}


void I18nProduct_seo::setTitle(utility::string_t value)
{
    m_Title = value;
    m_TitleIsSet = true;
}
bool I18nProduct_seo::titleIsSet() const
{
    return m_TitleIsSet;
}

void I18nProduct_seo::unsetTitle()
{
    m_TitleIsSet = false;
}

utility::string_t I18nProduct_seo::getKeywords() const
{
    return m_Keywords;
}


void I18nProduct_seo::setKeywords(utility::string_t value)
{
    m_Keywords = value;
    m_KeywordsIsSet = true;
}
bool I18nProduct_seo::keywordsIsSet() const
{
    return m_KeywordsIsSet;
}

void I18nProduct_seo::unsetKeywords()
{
    m_KeywordsIsSet = false;
}

utility::string_t I18nProduct_seo::getDescription() const
{
    return m_Description;
}


void I18nProduct_seo::setDescription(utility::string_t value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}
bool I18nProduct_seo::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void I18nProduct_seo::unsetDescription()
{
    m_DescriptionIsSet = false;
}
