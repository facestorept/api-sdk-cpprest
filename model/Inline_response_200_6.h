...
#ifndef IO_SWAGGER_CLIENT_MODEL_Inline_response_200_6_H_
#define IO_SWAGGER_CLIENT_MODEL_Inline_response_200_6_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<Product>>& getData();
    bool dataIsSet() const;
    void unsetData();
    void setData(std::vector<std::shared_ptr<Product>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    std::vector<std::shared_ptr<Product>> m_Data;
    bool m_DataIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_Inline_response_200_6_H_ */
