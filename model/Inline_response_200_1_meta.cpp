...
Inline_response_200_1_meta::Inline_response_200_1_meta()
{
    m_Total = utility::conversions::to_string_t("");
    m_TotalIsSet = false;
}
...
void Inline_response_200_1_meta::validate()
{
    // TODO: implement validation
}

web::json::value Inline_response_200_1_meta::toJson() const
{
...
void Inline_response_200_1_meta::fromJson(web::json::value& val)
{
    if(val.has_field(utility::conversions::to_string_t("total")))
    {
        setTotal(ModelBase::stringFromJson(val[utility::conversions::to_string_t("total")]));
    }
}

void Inline_response_200_1_meta::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Inline_response_200_1_meta::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
    ...
    {
        setTotal(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("total"))));
    }
}

utility::string_t Inline_response_200_1_meta::getTotal() const
{
    return m_Total;
}


void Inline_response_200_1_meta::setTotal(utility::string_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}
bool Inline_response_200_1_meta::totalIsSet() const
{
    return m_TotalIsSet;
}

void Inline_response_200_1_meta::unsetTotal()
{
    m_TotalIsSet = false;
}
