...
#ifndef IO_SWAGGER_CLIENT_MODEL_Inline_response_201_H_
#define IO_SWAGGER_CLIENT_MODEL_Inline_response_201_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<Brand>>& getData();
    bool dataIsSet() const;
    void unsetData();
    void setData(std::vector<std::shared_ptr<Brand>> value);

protected:
    std::vector<std::shared_ptr<Brand>> m_Data;
    bool m_DataIsSet;
};
...
#endif /* IO_SWAGGER_CLIENT_MODEL_Inline_response_201_H_ */
