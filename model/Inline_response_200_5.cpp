...
std::vector<std::shared_ptr<Payment>>& Inline_response_200_5::getData()
{
    return m_Data;
}

void Inline_response_200_5::setData(std::vector<std::shared_ptr<Payment>> value)
{
    m_Data = value;
    m_DataIsSet = true;
}
bool Inline_response_200_5::dataIsSet() const
{
    return m_DataIsSet;
}

void Inline_response_200_5::unsetData()
{
    m_DataIsSet = false;
}
