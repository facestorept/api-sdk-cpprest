...
std::vector<std::shared_ptr<Brand>>& Inline_response_201::getData()
{
    return m_Data;
}

void Inline_response_201::setData(std::vector<std::shared_ptr<Brand>> value)
{
    m_Data = value;
    m_DataIsSet = true;
}
bool Inline_response_201::dataIsSet() const
{
    return m_DataIsSet;
}

void Inline_response_201::unsetData()
{
    m_DataIsSet = false;
}
